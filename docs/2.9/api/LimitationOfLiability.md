...
![](images/achtung1.gif) Although care has been taken, the software and documentation are not represented to be error-free. EPLAN disclaims all warranties, either expressed or implied, regarding the software package, its merchantability, or its fitness as well as regarding the version compatibility as for functions and command syntax of programming interfaces.
